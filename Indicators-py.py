...
#This function is supposed to combine the arrays, it needs to be a Matrix. 
#!!!!I'm going to throw together the basic code for a matrix, but it is almost definitly not structured correctly
